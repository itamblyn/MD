!       program cbn_from_xyz.f90
!***********************************************************
!       Original code written by I.Tamblyn in python
!       This code was then translated to fortran by B.Boates for
!       speedup.
!       Subsequent extention to variable cells by I.Tamblyn
!***********************************************************
        implicit none
